...
exports.default = function () {
  var SimplechartView = wp.media.View.extend({
    ...
    updateInput: function updateInput(event) {
      ...
      this.$el.find('.simplechart-toolbar').find(':input').each(function (idx, el) {
...
document.addEventListener('DOMContentLoaded', function () {
  wp.media.controller.Simplechart = (0, _simplechartController2.default)();
  wp.media.view.Toolbar.Simplechart = (0, _simplechartToolbar2.default)();
  wp.media.view.SimplechartItem = (0, _simplechartItem2.default)();
  wp.media.view.Simplechart = (0, _simplechartView2.default)();
  wp.media.view.MediaFrame.Post = (0, _simplechartPostFrame2.default)();
});

/***/ })
/******/ ]);
//# sourceMappingURL=simplechartInsert.js.map